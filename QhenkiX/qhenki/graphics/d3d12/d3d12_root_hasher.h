...
public:
     ...
     *
     * Hashes the binary data of a root signature, creates the root signature object and stores it in a map with hash
     * object pairing.
     *
     ...
     * @return A pointer to the created ID3D12RootSignature object. nullptr if the root signature already exists (might
     * be hash collision) or creation failed.
     */
