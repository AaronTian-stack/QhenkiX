...
struct Basis
{
    ...
    explicit Basis(const XMFLOAT3& x, const XMFLOAT3& y, const XMFLOAT3& z)
        : basis(x.x, y.x, z.x, x.y, y.y, z.y, x.z, y.z, z.z)
    {
    }
    explicit Basis(const XMFLOAT3X3& basis)
        : basis(basis)
    {
    }
    ...
    XMFLOAT3 axis_x() const
    {
        return {basis._11, basis._12, basis._13};
    }
    XMFLOAT3 axis_y() const
    {
        return {basis._21, basis._22, basis._23};
    }
    XMFLOAT3 axis_z() const
    {
        return {basis._31, basis._32, basis._33};
    }
