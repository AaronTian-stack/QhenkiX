...
function(add_shader_targets TARGET_NAME CONFIG_PATH)
    ...
    if(WIN32)
        ...
        list(APPEND _shader_aggregate_deps ${TARGET_NAME}_CompileShaders_DX12)
    endif()
    ...
    list(APPEND _shader_aggregate_deps ${TARGET_NAME}_CompileShaders_Vulkan)

    add_custom_target(${TARGET_NAME}_CompileShaders ALL
        DEPENDS ${_shader_aggregate_deps}
    )
